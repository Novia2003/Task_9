...
public class NewListTest {
    ...
    public void createNewList1() {
        ...
        List<Integer> trueList = ArrayUtils.readListFromFile("testSrc/TestFiles/TestResult/output01.txt", 0);

        assert firstList != null && secondList != null;

        NewList newList = new NewList(firstList, secondList);
        Assert.assertEquals(newList.createNewList(), trueList);
    }
    ...
    public void createNewList2() {
        ...
        List<Integer> trueList = ArrayUtils.readListFromFile("testSrc/TestFiles/TestResult/output02.txt", 0);
    ...
    public void createNewList3() {
        ...
        List<Integer> trueList = ArrayUtils.readListFromFile("testSrc/TestFiles/TestResult/output03.txt", 0);
    ...
    public void createNewList4() {
        ...
        List<Integer> trueList = ArrayUtils.readListFromFile("testSrc/TestFiles/TestResult/output04.txt", 0);
    ...
    public void createNewList5() {
        ...
        List<Integer> trueList = ArrayUtils.readListFromFile("testSrc/TestFiles/TestResult/output05.txt", 0);
    ...
    public void createNewList6() {
        ...
        List<Integer> trueList = ArrayUtils.readListFromFile("testSrc/TestFiles/TestResult/output06.txt", 0);
    ...
    public void createNewList7() {
        ...
        List<Integer> trueList = ArrayUtils.readListFromFile("testSrc/TestFiles/TestResult/output07.txt", 0);
    ...
    public void createNewList8() {
        ...
        List<Integer> trueList = ArrayUtils.readListFromFile("testSrc/TestFiles/TestResult/output08.txt", 0);
    ...
    public void createNewList9() {
        ...
        List<Integer> trueList = ArrayUtils.readListFromFile("testSrc/TestFiles/TestResult/output09.txt", 0);
    ...
    public void createNewList10
        ...
        List<Integer> trueList = ArrayUtils.readListFromFile("testSrc/TestFiles/TestResult/output10.txt", 0);
